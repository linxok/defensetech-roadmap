# Реальний сценарій 10

## Сценарій

Флот з 100 дронів відправляє телеметрію. Backend має масштабовано зберігати дані, роздавати їх GCS і AI, забезпечувати доступність 99.9%.
