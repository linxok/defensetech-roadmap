...
Дрони використовують комп’ютерний зір для розвідки, навігації, пошуку цілей, інспекції, доставки. Основні задачі: детекція, трекінг, сегментація, OCR, відеоаналітика.

## Теми модуля

- **OpenCV** — обробка зображень і відео.
- **YOLO** — realtime object detection.
- **SAM** — сегментація будь-яких об’єктів.
- **OCR** — розпізнавання тексту.
- **Object Tracking** — DeepSORT, ByteTrack.
- **Segmentation** — семантична і інстансна.
...
Модуль 12 не існує ізольовано. Його знання поєднуються з попередніми і наступними модулями. Наприклад, Linux і мережі використовуються в MAVLink, Python/C++ — для backend, ROS2 і CV — для AI, а DevOps — для розгортання. Курс побудований так, щоб кожен модуль доповнював загальну картину.
