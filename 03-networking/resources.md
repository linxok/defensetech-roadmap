# Ресурси 03: Мережі для робототехніки
...
- Designing Data-Intensive Applications — Martin Kleppmann (розділи про надійність)
- MAVLink: UDP vs TCP — https://mavlink.io/en/
