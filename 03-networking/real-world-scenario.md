# Реальний сценарій 03

## Сценарій

Побудуйте зв’язок між 50 дронами і наземною станцією. Телеметрія має йти з низькою латентцією, команди — надійно, відео — окремим каналом.
