...
Контракт gRPC (`solution/telemetry.proto`, компіляція — крок у `lab.md`), приклад клієнта (`examples/grpc_client.py`) і таблиця порівняння транспортів.

## Зв'язок з capstone

Розділ «Що далі» в `capstone/README.md`: при зростанні флоту capstone може перейти з HTTP на gRPC або Kafka — рішення задокументувати.
